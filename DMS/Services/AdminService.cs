...
namespace DAS.Services
{
    public class AdminService : IAdminService
    {
        ...
        public AdminService(DasContext context, IConfiguration configuration)
        {
            this.context = context;
            this.configuration = configuration;
        }

        public async Task<MetaField> AddMetaField(MetaField model)
        {
            try
            {
                ...
                if (exist != null)
                {
                    throw new Exception($"Field with name='{model.Name}' is already existed");
                }
        ...
        public async Task UpdateMetaField(int? id, MetaField model)
        {
            try
            {
                if (!id.HasValue)
        ...
        public async Task<MetaField> DeleteMetaField(int? id, string force = null)
        {
            try
            {
                if (!id.HasValue)
        ...
        public async Task<RepositoryMeta> AddRepoMetaValue(int id, string name, string value = null)
        {
            try
            {
                ...
                if (repo == null)
                {
                    throw new Exception($"Repository with id='{id}' not found");
                }
        ...
        public async Task<FolderMeta> AddFolderMetaValue(int id, string name, string value = null)
        {
            try
            {
                if (string.IsNullOrEmpty(name))
        ...
        public async Task<DocumentMeta> AddDocumentMetaValue(int id, string name, string value = null)
        {
            try
            {
                if (string.IsNullOrEmpty(name))
        ...
        public async Task<RepositoryMeta> SetRepoMetaValue(int id, string name, string value = null)
        {
            try
            {
                if (string.IsNullOrEmpty(name))
        ...
        public async Task<FolderMeta> SetFolderMetaValue(int id, string name, string value = null)
        {
            try
            {
                if (string.IsNullOrEmpty(name))
        ...
        public async Task<DocumentMeta> SetDocumentMetaValue(int id, string name, string value = null)
        {
            try
            {
                if (string.IsNullOrEmpty(name))
        ...
        public async Task<RepositoryMeta> DeleteRepoMetaValue(int id, string name)
        {
            try
            {
                if (string.IsNullOrEmpty(name))
        ...
        public async Task<FolderMeta> DeleteFolderMetaValue(int id, string name)
        {
            try
            {
                if (string.IsNullOrEmpty(name))
        ...
        public async Task<DocumentMeta> DeleteDocumentMetaValue(int id, string name)
        {
            try
            {
                if (string.IsNullOrEmpty(name))
        ...
        public async Task<RepoDetailModel> AddRepository(RepoAddModel model)
        {
            try
            {
                if (string.IsNullOrEmpty(model.Name))
        ...
        public async Task UpdateRepository(string id, RepoUpdateModel model)
        {
            try
            {
        ...
        public async Task<RepoDetailModel> DeleteRepository(int? id, string username)
        {
            try
            {
                if (!id.HasValue)
        ...
        public async Task<FolderDetailModel> DeleteFolder(int? id, string username)
        {
            try
            {
                if (!id.HasValue)
        ...
        public async Task<DocumentDetailModel> DeleteDocument(int? id, string username)
        {
            try
            {
                if (!id.HasValue)
